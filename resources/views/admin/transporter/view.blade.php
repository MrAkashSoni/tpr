                    ...
                    <div id="services" class="collapse show" aria-labelledby="serviceheading" data-parent="#extraview">
                        <div class="card-body">
                            <table class="table table-striped" style="table-layout:fixed; width:100%">
                                ...
                                @for ($i = 1; $i <= 5; $i++) <tr>
                                    <td id="fromstate{{$i}}"></td>
                                    <td id="fromcities{{$i}}"></td>
                                    <td id="tostate{{$i}}"></td>
                                    <td id="tocities{{$i}}"></td>
                                    <td id="trucks{{$i}}"></td>
                                    <td id="commodities{{$i}}"></td>
                                    </tr>
                                    @endfor
                                    <tbody>
                                    </tbody>
                        ...
                        <div class="card-body">
                            <table id="contacttable" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    @for ($i = 1; $i <= 5; $i++) <tr>
                                        <td id="viewname{{$i}}"></td>
                                        <td id="viewmobile1{{$i}}"></td>
                                        <td id="viewmobile2{{$i}}"></td>
                                        <td id="viewwhatsapp{{$i}}"></td>
                                        </tr>
                                        @endfor
                                </tbody>
                            </table>
                    ...
                    <div id="banks" class="collapse" aria-labelledby="banksheading" data-parent="#extraview">
                        <div class="card-body">
                            <table id="banktable" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    @for ($i = 1; $i <= 5; $i++) <tr>
                                        <td id="holdername{{$i}}"></td>
                                        <td id="accountnumber{{$i}}"></td>
                                        <td id="bankname{{$i}}"></td>
                                        <td id="bankbranch{{$i}}"></td>
                                        <td id="ifsccode{{$i}}"></td>
                                        </tr>
                                        @endfor
                                </tbody>
